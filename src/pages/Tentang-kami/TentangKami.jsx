      ...
      <section className="pt-[6rem]" id="tentang-kami">
        ...
        <div className="flex">
          <div className="w-cols p-6 my-8 ml-20 flex flex-col rounded-md mb-20">
            ...
            <P className="2 mb-4">Platform “Pencarian Lapak Sentra” ini adalah solusi kreatif untuk pemilik kosan dalam mempromosikan Kos-kosanya.</P>
            <P className="2 mb-20">
            Maka dari itu platform “Lapak Sentra” ini menyediakan platfrom bagi pemilik kost dan penyewa kost agar bisa dengan mudah dalam mencari kost secara online melalui platform ini.
            </P>
          </div>
