...
import PilihH from "../../data/SemuaData";
...
import menu from "../../data/SemuaData";
...
function Hunian() {
  ...
  return (
    <>
      ...
      <section
        className="pt-[10rem] mb-[2rem] font-worksans"
        id="fasilitasrumah"
      >
            ...
            <form action="" className="flex justify-center gap-20">
              ...
              <div className="w-[40%] ">
                <div className="filter-jenis font-medium relative">
                  <div className="label">
                    <label className="text-lg">RENTANG HARGA</label>
                  </div>
                  <div className="input text-primary_70 h-50 w-[100%] absolute flex items-center gap-3">
                    <input
                      type="text"
                      className="p-2 border border-primary_70 rounded bg-slate-50 w-full"
                      placeholder="0"
                    />
